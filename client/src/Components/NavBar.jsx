            ...
            <div>
               <p>
                  <span className={navStyles.letterSpacing}>
                     <span className={navStyles.caps}>R</span>ICKY
                     <span className={navStyles.caps}> K</span>ELLE
                  </span>
                  Y
               </p>
               <hr />
               <p className={navStyles.secondLine}>
                  <span className={navStyles.letterSpacing2}>PHOTOGRAPH</span>Y
               </p>
            </div>
         </Link>
